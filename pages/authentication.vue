    ...
    <div class="bot-content">
      <form v-if="state === 'register'" class="register-form">
        ...
        <div class="in">
          ...
          <img src="~/assets/icons/show-password-input.svg" @click="form.register.password.type === 'password' ? form.register.password.type = 'text' : form.register.password.type = 'password'">
        </div>
        <div class="in">
          ...
          <img src="~/assets/icons/show-password-input.svg" @click="form.register.confirmPassword.type === 'password' ? form.register.confirmPassword.type = 'text' : form.register.confirmPassword.type = 'password'">
        </div>
        <div class="in">
      ...
      <form v-if="state === 'login'">
        ...
        <div class="in">
          ...
          <img src="~/assets/icons/show-password-input.svg" @click="form.login.password.type === 'password' ? form.login.password.type = 'text' : form.login.password.type = 'password'">
        </div>
        <a href="#" :disabled="form.block" @click="fetchLogin">
          Continue
          <img src="~/assets/icons/continue.svg">
        </a>
      </form>
...
<script>
import { ref, reactive, useRouter, useContext, defineComponent } from '@nuxtjs/composition-api'
